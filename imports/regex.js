...
function main(rs) {
  ...
  }, 'Regex: match pattern against string. Return array of all matches.'));
  ...
  }, 'Regex: match pattern against string. Return array of all captures with information.'));
  ...
  }, 'Regex: test pattern against an input. Return boolean match.'));
}
